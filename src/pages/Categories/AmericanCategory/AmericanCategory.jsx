...
import styles from "./AmericanCategory.module.css";
  ...
  return (
    <>
      ...
      <div className={styles.ItalianCategory}>
        <div>
          <div className={styles.categorytitle}>AMERICAN CUISINE</div>
          <nav>
...
export default AmericanCategory;